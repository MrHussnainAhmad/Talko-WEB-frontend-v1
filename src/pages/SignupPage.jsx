  ...
  const handleSubmit = async (e) => {
    ...
    if (isValid) {
      ...
      if (result.success) {
        ...
        // Show verification notice instead of logging in immediately
  ...
  return (
    <>
      <div className="min-h-screen grid lg:grid-cols-2 bg-gradient-to-br from-purple-100 via-purple-200 to-indigo-200">
          ...
          <div className="w-full max-w-md space-y-8">
            <div className="text-center mb-8">
              <div className="flex flex-col items-center gap-5 group">
                ...
                <p className="text-base-center/60">Join our secure chat platform</p>
              </div>
            </div>
        ...
        {/* Right-Side */}
        <AuthImage 
          title="Start Your Private Chat, Today!" 
